class DisplayordersController < ApplicationController
  ...
  def accepted
    ...
    @customerhires = Customerhire.joins('join driverpickups on customerhires.id = driverpickups.customerhire_id and customerhires.order_status = "accepted" and driverpickups.driver_id = ' + current_user.id.to_s)
